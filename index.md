Hello! My name is Jakub Holý and I am a full-stack Clojure(Script) developer by day and a pair-programming partner for hire by night via [my company Holy Dev](holy-dev.html).
